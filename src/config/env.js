...
module.exports = {
  ...
  EMAIL_FROM: (process.env.EMAIL_FROM || 'Tribo <noreply@tribo-brasil.app.br>').replace(/^["']|["']$/g, '').trim(),
  APP_URL: (process.env.APP_URL || 'https://tribo-brasil.app.br').replace(/^["']|["']$/g, '').trim(),
  LIVE_VOICE_DIAGNOSTICS: process.env.LIVE_VOICE_DIAGNOSTICS === 'true',
